...
// Ensure, that RelayRepositoryMock does implement app.RelayRepository.
// If this is not the case, regenerate this file with moq.
var _ app.RelayRepository = &RelayRepositoryMock{}

// RelayRepositoryMock is a mock implementation of app.RelayRepository.
//
// 	func TestSomethingThatUsesRelayRepository(t *testing.T) {
//
// 		// make and configure a mocked app.RelayRepository
...
// 		}
//
// 		// use mockedRelayRepository in code that requires app.RelayRepository
...
func (mock *RelayRepositoryMock) FindByKey(ctx context.Context, key string) (zone.Relay, error) {
	if mock.FindByKeyFunc == nil {
		panic("RelayRepositoryMock.FindByKeyFunc: method is nil but RelayRepository.FindByKey was just called")
	}
	callInfo := struct {
		Ctx context.Context
		Key string
...
//     len(mockedRelayRepository.FindByKeyCalls())
func (mock *RelayRepositoryMock) FindByKeyCalls() []struct {
	Ctx context.Context
	Key string
} {
	var calls []struct {
